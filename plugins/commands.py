...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃', url=f"https://t.me/Ankitpatel40")
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Ankitpatel005/Ajax-Extra-Features/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🇯‌🇴‌🇮‌🇳‌', url='https://t.me/+UAPWlbyITcdmOTZl') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
